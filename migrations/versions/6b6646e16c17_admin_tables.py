...
def upgrade():
    ...
    with op.batch_alter_table('billing_events', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_billing_events_external_id'), ['external_id'], unique=False)
    ...
    with op.batch_alter_table('message_log', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_message_log_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('payment_transactions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_payment_transactions_external_id'), ['external_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_payment_transactions_plan_key'), ['plan_key'], unique=False)
    ...
    op.create_table('user_perm_overrides',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('user_perm_overrides', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_perm_overrides_user_id'), ['user_id'], unique=False)
