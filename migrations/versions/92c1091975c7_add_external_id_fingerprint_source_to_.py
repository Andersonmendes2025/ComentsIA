...
def upgrade():
    ...
    op.create_table('reservation_index',
    ...
    sa.UniqueConstraint('user_id', 'source', 'external_id', name='uq_reservation_index_user_source_extid')
    )
    with op.batch_alter_table('reservation_index', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_reservation_index_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_reservation_index_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('upload_log', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_upload_log_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_upload_log_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('review', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_review_external_id'), ['external_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_review_fingerprint'), ['fingerprint'], unique=False)
