...
_Generated: 2026-06-20T19:43:05.742Z_
...
Workspace `mcp.json` _(folder: ComentsIA)_

- **c:\Users\Anderson Mendes\Documents\ComentsIA\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Anderson Mendes\.claude.json** — _File exists — no servers defined_
